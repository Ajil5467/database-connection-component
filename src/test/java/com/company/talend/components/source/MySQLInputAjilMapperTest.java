...
public class MySQLInputAjilMapperTest {
    ...
    public void produce() throws IOException {
        ...
        final MySQLInputAjilMapperConfiguration configuration =  new MySQLInputAjilMapperConfiguration()
                                                                            /* .setUsername()
                                                                               .setDataset()
                                                                               .setUrl()
                                                                               .setConfiguration4()
        ...
        final Mapper mapper = COMPONENT_FACTORY.createMapper(MySQLInputAjilMapper.class, configuration);
