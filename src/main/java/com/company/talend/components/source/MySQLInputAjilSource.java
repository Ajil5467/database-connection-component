...
public class MySQLInputAjilSource implements Serializable {
    private final MySQLInputAjilMapperConfiguration configuration;
    private final CompanyComponentService service;
    private final RecordBuilderFactory builderFactory;

    public MySQLInputAjilSource(@Option("configuration") final MySQLInputAjilMapperConfiguration configuration,
