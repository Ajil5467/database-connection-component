...
@Icon(value = CUSTOM, custom = "MySQLInputAjil") // icon is located at src/main/resources/icons/MySQLInputAjil.svg
@PartitionMapper(name = "MySQLInputAjil")
@Documentation("TODO fill the documentation for this mapper")
public class MySQLInputAjilMapper implements Serializable {
    private final MySQLInputAjilMapperConfiguration configuration;
    private final CompanyComponentService service;
    private final RecordBuilderFactory recordBuilderFactory;

    public MySQLInputAjilMapper(@Option("configuration") final MySQLInputAjilMapperConfiguration configuration,
    ...
    @Split
    public List<MySQLInputAjilMapper> split(@PartitionSize final long bundles) {
        ...
        // In this case bundles = 100 and we must try to return 10 MySQLInputAjilMapper with 1/10 of the overall work each.
        //
    ...
    @Emitter
    public MySQLInputAjilSource createWorker() {
        // here we create an actual worker,
        // you are free to rework the configuration etc but our default generated implementation
        // propagates the partition mapper entries.
        return new MySQLInputAjilSource(configuration, service, recordBuilderFactory);
    }
}