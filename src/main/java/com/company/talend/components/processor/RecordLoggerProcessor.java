...
@Icon(value = CUSTOM, custom = "RecordLogger") // icon is located at src/main/resources/icons/RecordLogger.svg
@Processor(name = "RecordLogger")
@Documentation("TODO fill the documentation for this processor")
public class RecordLoggerProcessor implements Serializable {
    private final RecordLoggerProcessorConfiguration configuration;
    private final CompanyComponentService service;

    public RecordLoggerProcessor(@Option("configuration") final RecordLoggerProcessorConfiguration configuration,
